...
# Shorten display labels for chart only
label_map = {
    'Architecture & Eng.': 'Eng. & Architecture',
    'Community & Social Svc.': 'Community & Social',
    'Installation & Repair': 'Installation/Repair',
    'Production & Mfg.': 'Production & Mfg.',
}
category_risk['Category'] = category_risk['Category'].replace(label_map)
...
st.markdown("""
This tool helps students and career explorers understand how AI and automation may affect different occupations,
based on research-based estimates from a landmark Oxford University study.
""")
...
- Career alternatives are generated by filtering same-category occupations with lower scores
- This tool covers 702 broad occupational categories. Highly specialized roles should be searched under their broader category (e.g. Nurse Anesthetist → Registered Nurses)
    """)

with st.expander("🤖 Model & data sources"):
    st.markdown("""
**Data source:**
...
using SOC group and employment features. The public-facing susceptibility score displayed in this app
...
with st.expander("⚠️ Limitations"):
    st.markdown("""
- Scores reflect a **historical** task-based automation study (2017) and should not be interpreted as a current forecast
- AI is more likely to change individual tasks within a role than to replace entire occupations
- Automation susceptibility varies by employer, geography, and specialization — these are estimates, not certainties
- Use these scores as a starting point for career exploration, not as a definitive prediction
    """)

st.markdown("---")
st.caption("Data sourced from Frey & Osborne (2017) · BLS OEWS 2023 · O*NET Online 2026")
